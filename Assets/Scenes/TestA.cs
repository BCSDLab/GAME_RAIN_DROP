...
public class TestA : MonoBehaviour
{
    ...
    public void OnBtnGetScoreClicked()
    {
        ...
        if(nScore.Equals(1000))
            PlayGamesPlatform.Instance.IncrementAchievement(GPGSIds.achievement__or__or__or__1000, nStep, (bool success) =>
            {
                if (success)
                {
    ...
    public void OnBtnHiddenClicked()
    {
        ...
        if (nIQ.Equals(50))
        {
            ...
            Social.ReportProgress(GPGSIds.achievement_iq_200, 0f, (bool success) =>
            {
                if (success)
                {
                    Debug.Log("IQ 공개 성공");
        ...
        if(nIQ <= 200 && (nIQ % 100).Equals(0))
            PlayGamesPlatform.Instance.IncrementAchievement(GPGSIds.achievement_iq_200, nStep, (bool success) =>
            {
                if (success)
                {
                    if (nIQ.Equals(200))
